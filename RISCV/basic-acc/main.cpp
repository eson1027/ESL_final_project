...
public:
	...
	//core 1
	addr_t sobelFilter0_start_addr = 0x73000000;
 	addr_t sobelFilter0_size = 0x01000000;
 	addr_t sobelFilter0_end_addr = sobelFilter0_start_addr + sobelFilter0_size - 1;
	//core 2
	addr_t sobelFilter1_start_addr = 0x74000000;
 	addr_t sobelFilter1_size = 0x01000000;
 	addr_t sobelFilter1_end_addr = sobelFilter1_start_addr + sobelFilter1_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	CombinedMemoryInterface iss0_mem_if("MemoryInterface", core0);
	CombinedMemoryInterface iss1_mem_if("MemoryInterface", core1);
	...
	// address mapping
	{
		...
		//Add
		bus.ports[it++] = new PortMapping(opt.sobelFilter0_start_addr, opt.sobelFilter0_end_addr);
		bus.ports[it++] = new PortMapping(opt.sobelFilter1_start_addr, opt.sobelFilter1_end_addr);
