...
const int E[48] = {32, 1, 2, 3, 4, 5, 4, 5,
                    6, 7, 8, 9, 8, 9, 10, 11,
...
union word {
    int64_t sint;               // Signed 64-bit integer
    uint64_t uint;              // Unsigned 64-bit integer
    unsigned char uc[8];        // Array of 8 unsigned chars (64 bits in total)
};
